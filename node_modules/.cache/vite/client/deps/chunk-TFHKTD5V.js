...
// node_modules/@sanity/client/dist/_chunks/browserMiddleware-jPnXCUlp.js
...
var validateApiVersion = function(apiVersion) {
...
function _fetch(client, httpRequest, _stega, query, _params = {}, options = {}) {
  ...
  return stega.enabled ? $request.pipe(
    combineLatestWith(
      from(
        import("./stegaEncodeSourceMap-De3F_oJN-M74KNVHD.js").then(function(n) {
...
function _listen(query, params, opts = {}) {
  ...
  return (token || withCredentials) && (esOptions.withCredentials = true), token && (esOptions.headers = {
    ...
    async function getEventSource() {
      const { default: EventSource } = await import("./browser-7FG7DRMF.js"), evs = new EventSource(uri, esOptions);
...
is-plain-object/dist/is-plain-object.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-TFHKTD5V.js.map
