...
// node_modules/sanity-blocks-vue-component/dist/index.esm.js
...
var createElementFromStyle = function(block, serializers, children) {
  ...
  return children.flatMap(function(a) {
    return a;
  });
};
...
var serializerIsVueComponent = function(serializer) {
  return typeof serializer === "object" && ("template" in serializer || "setup" in serializer || "render" in serializer || "ssrRender" in serializer);
};
...
var attachMarks = function(span, remainingMarks, serializers, markDefs) {
  ...
  var markDef = mark in serializers.marks ? { _type: mark, _key: "" } : markDefs.find(function(m) {
    return m._key === mark;
  });
  ...
  if (serializerIsVueComponent(serializer)) {
    ...
    return h(serializer, props, function() {
...
var underlineSerializer = function(_, children) {
  return h("span", { style: "text-decoration: underline;" }, children);
};
var linkSerializer = function(props, children) {
  return h("a", { href: props.href, target: props.newtab ? "_blank" : void 0 }, children);
};
...
var extractProps = function(item) {
  if (item) {
    item._key;
    item._type;
    var props = __rest(item, ["_key", "_type"]);
    return props;
  }
  return {};
};
...
var nestBlocks = function(blocks, level) {
  ...
  var hasChildren = function(block) {
    return block && "children" in block;
  };
  var newBlocks = [];
  blocks.forEach(function(block) {
    ...
    if (block.level && block.level > level) {
      if (!hasChildren(lastBlock) || !isListOrListItem(lastBlock) || lastBlock.level && lastBlock.level > block.level) {
...
var renderBlocks = function(blocks, serializers, level) {
  ...
  return nestedBlocks.map(function(block) {
    return serializeBlock(block, serializers);
  }).filter(notNull);
};
...
var SanityBlocks = defineComponent({
  functional: true,
  props: {
    blocks: {
      type: Array,
  ...
  setup: function(props) {
    var serializers = (0, import_lodash.default)({}, defaultSerializers, props.serializers);
    return function() {
...
sanity-blocks-vue-component/dist/index.esm.js:
  (*! *****************************************************************************
  ...
  ***************************************************************************** *)
*/
//# sourceMappingURL=sanity-blocks-vue-component.js.map
