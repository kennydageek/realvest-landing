...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/_id_-303f7569.js").then((m) => m.default || m)
  },
  {
    name: "blog",
    path: "/blog",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-7e267d76.js").then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-a29bae36.js").then((m) => m.default || m)
  },
  {
    name: "privacy",
    path: "/privacy",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/privacy-a1a5c15a.js").then((m) => m.default || m)
  },
  {
    name: "terms",
    path: "/terms",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/terms-f9a0c9e8.js").then((m) => m.default || m)
  }
];
...
const layouts = {
  default: () => import("./_nuxt/default-e5229af4.js").then((m) => m.default || m)
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/error-404-e89af22b.js").then((r) => r.default || r));
    const _Error = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/error-500-4eac8afb.js").then((r) => r.default || r));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/island-renderer-134ed4f9.js").then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
